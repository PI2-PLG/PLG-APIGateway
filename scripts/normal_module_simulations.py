...
for collect in range(1,quantity_of_collects):
    string_data_A = f'M:Modulo-A,P:{random.randint(200,500)},T:{random.randint(25,33)},U:{random.randint(40,90)},L:{-15.98961},G:{-48.0443975},V:{0}, W:{-70}'
    string_data_B = f'M:Modulo-A,P:{random.randint(200,500)},T:{random.randint(30,33)},U:{random.randint(30,80)},L:{-15.9906929},G:{-48.0443009},V:{0}, W:{-60}'
    string_data_C = f'M:Modulo-A,P:{random.randint(200,500)},T:{random.randint(20,28)},U:{random.randint(35,75)},L:{-15.9906929},G:{-48.0443009},V:{0}, W:{-48}'
    string_data_D = f'M:Modulo-A,P:{random.randint(200,500)},T:{random.randint(27,35)},U:{random.randint(25,65)},L:{-15.9941734},G:{-48.0460925},V:{0},W:{-52}'
