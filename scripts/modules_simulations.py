...
for collect in range(1,quantity_of_collects):
    ...
    string_data_D = f'M:Modulo-D,P:{random.randint(200,500)},T:{random.randint(25,30)},U:{random.randint(25,85)},L:{-15.988280},G:{-48.044277},V:{0},W:{-48}'
