...
for collect in range(1,quantity_of_collects):
    string_data_A = f'M:Modulo-A,P:{random.randint(200,500)},T:{random.randint(25,30)},U:{random.randint(25,85)},L:{-15.990043},G:{-48.046277},V:{0}'
    string_data_B = f'M:Modulo-B,P:{random.randint(200,500)},T:{random.randint(25,30)},U:{random.randint(25,85)},L:{-15.990846},G:{-48.045164},V:{0}'
    string_data_C = f'M:Modulo-C,P:{random.randint(200,500)},T:{random.randint(25,30)},U:{random.randint(25,85)},L:{-15.989804},G:{-48.043127},V:{0}'
    string_data_D = f'M:Modulo-D,P:{random.randint(200,500)},T:{random.randint(25,30)},U:{random.randint(25,85)},L:{-15.988280},G:{-48.044277},V:{0}'
